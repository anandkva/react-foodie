        ...
        return (
            <div className="container">
                ...
                <div className="titlecase">
                    ...
                    <Link className="s-btn btn btn-danger" to="/"><i className="fa fa-home"></i> Home</Link>
                    &nbsp;<button className="s-btn btn btn-outline-danger"><i className="fa fa-comments"></i> Add Review</button>
                    &nbsp;<button className="s-btn btn btn-outline-danger"><i className="fa fa-map-marker"></i> Direction</button>
                    &nbsp;<button className="s-btn btn btn-outline-danger"><i className="fa fa-bookmark"></i> Add Bookmark</button>
                    &nbsp;<button className="s-btn btn btn-outline-danger"><i className="fa fa-share"></i> share</button>
                </div>
